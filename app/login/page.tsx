...
import { ArrowRight, ChefHat, FileUp, QrCode, ShieldCheck, Sparkles } from "lucide-react";
            ...
            <div className="relative z-10 flex min-h-[440px] flex-col justify-between">
              ...
              <div className="max-w-md">
                ...
                <h1 className="mt-5 text-4xl font-semibold leading-tight tracking-tight md:text-5xl">
                  Continue managing your restaurant menu workspace.
                </h1>
                <p className="mt-5 leading-7 text-white/68">
                  Supabase auth protects dashboard access and keeps restaurant
                  menu records tied to the right owner.
                </p>
              </div>
          ...
          <section className="flex items-center p-5 md:p-8 lg:p-10">
            <div className="w-full">
              <form action={login} className="rounded-[1.5rem] border border-[#e5dccf] bg-white p-5 shadow-sm md:p-6">
                ...
                <button className="mt-6 inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-2xl bg-[var(--charcoal)] px-4 text-sm font-semibold text-white transition hover:-translate-y-0.5 hover:bg-[#30332d]">
                  Login
                  <ArrowRight size={17} />
                </button>
              </form>
